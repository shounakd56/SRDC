...
python main.py  --data_path_source ./data/datasets/Office31/  --src amazon  --data_path_target ./data/datasets/Office31/  --tar webcam  --data_path_target_t ./data/datasets/Office31/  --tar_t webcam #
